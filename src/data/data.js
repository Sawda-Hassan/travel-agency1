...
export const destinations = [
  ...
  },
  {
    ...
    imageUrl: "https://via.placeholder.com/400x250/A1FF33/FFFFFF?text=Dhuusamareeb", // No specific image provided, keeping placeholder
    rating: 4.0,
  ...
  },
  {
    ...
    imageUrl: "https://via.placeholder.com/400x250/33FFFF/FFFFFF?text=Galkayo", // No specific image provided, keeping placeholder
    rating: 3.9,
  ...
  },
  {
    id: "baidoa",
    name: "Baidoa",
    description: "A historic city in the Bay region, known for its agricultural produce and strategic importance.",
    imageUrl: "https://via.placeholder.com/400x250/FFC300/FFFFFF?text=Baidoa", // No specific image provided, keeping placeholder
    rating: 4.1,
    infoLink: "/destinations/baidoa",
    attractions: ["Baidoa Market", "Agricultural Lands", "Historical Sites (local)"],
    culture: "Rich in agricultural traditions and a hub for regional trade, reflecting the resilience of its people.",
    travelTips: "Explore the local markets for fresh produce. Learn about the traditional farming methods.",
    reviews: [
      { user: "Said", text: "The freshest produce I've seen, a vibrant market." },
      { user: "Fadumo", text: "Learned a lot about local farming, very insightful." },
    ]
  },
  {
    id: "garowe",
    name: "Garowe",
    description: "The administrative capital of Puntland, a well-planned city with modern infrastructure and a growing economy.",
    imageUrl: "https://via.placeholder.com/400x250/8D33FF/FFFFFF?text=Garowe", // No specific image provided, keeping placeholder
    rating: 4.2,
    infoLink: "/destinations/garowe",
    attractions: ["Puntland Parliament Building", "Garowe University", "Central Park"],
    culture: "A modern administrative center with a strong focus on governance and education.",
    travelTips: "Observe the modern development and infrastructure. A good base for exploring Puntland.",
    reviews: [
      { user: "Ismail", text: "Impressive infrastructure for the region, well-organized city." },
      { user: "Zahra", text: "The university area is lively, good place to meet people." },
    ]
  },
];