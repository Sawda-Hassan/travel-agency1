...
import PackageCard from './PackageCard'; // Adjust path if necessary
import { packages, testimonials } from '../data/data'; // Import packages and testimonials
            ...
            <section className="search-bar-section">
                <div className="container">
                    ...
                    <div className="search-bar-container">
                        <input type="text" placeholder="Search destinations, packages..." className="search-input" />
                ...
                <div className="container">
                    ...
                    <div className="features-grid">
                        <div className="feature-item">
                            ...
                            <p>Explore Somalia's unique regions, from the coastal beauty of Mogadishu to the highlands of Hargeisa.</p>
                        </div>
                        <div className="feature-item">
                            <i className="fas fa-headset icon"></i>
                            <h3>24/7 Support</h3>
                            <p>Our dedicated team is available around the clock to assist you with any travel needs.</p>
                        </div>
                        <div className="feature-item">
                            <i className="fas fa-hand-holding-usd icon"></i>
                            <h3>Best Price Guarantee</h3>
                            <p>We offer competitive pricing and exclusive deals to give you the best value for your money.</p>
                        </div>
                        <div className="feature-item">
                            <i className="fas fa-star icon"></i>
                            <h3>Expert Guidance</h3>
                            <p>Benefit from personalized recommendations and itineraries crafted by experienced travel advisors.</p>
                        </div>
                    </div>
                </div>
            </section>
